          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder="+91 98765 43210" required className="w-full bg-[#FBF7F0] border border-[#B07D3F]/15 rounded-xl py-3.5 pl-11 pr-4 font-body text-sm text-[#2B2118] placeholder:text-[#2B2118]/30 outline-none focus:border-[#7B2D43]/40 focus:shadow-[0_0_0_4px_rgba(123,45,67,0.06)] transition-all duration-300" />
              </div>
            </div>

            <div>
              <label className="font-accent font-light text-[10px] tracking-[0.35em] uppercase text-[#2B2118]/60 ml-1 block mb-2">Email Address</label>
              <div className="relative">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-3 py-4 rounded-full bg-gradient-to-br from-[#8E3650] via-[#7B2D43] to-[#5C1F31] text-[#FBF7F0] font-accent font-medium text-[12px] tracking-[0.25em] uppercase shadow-[0_10px_30px_-8px_rgba(123,45,67,0.55),inset_0_1px_0_rgba(255,255,255,0.18)] hover:shadow-[0_16px_40px_-8px_rgba(123,45,67,0.6)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-400 disabled:opacity-60 disabled:pointer-events-none mt-2"
            >
              {submitting ? (
